...
// document.getElementById("text") ); ReactDOM.render(<Header></Header>,
...
// class Index extends Component {
  ...
  constructor() {
    ...
    this.changeAddress = this
      .changeAddress
      .bind(this);
  }

  changeAddress() {
    this.setState({address: "朝外大街乙6号soho-A座1106"});
  }
...
// 为组件属性定义类型检测 import "prop-types" component.propTypes = {propName: PropTypes.any} PropTypes.string.isRequired
Index.propTypes = {
  // appName: PropTypes.string.isRequired
  appName: PropTypes.string.isRequired
}
// 为组件属性定义默认值 defaultProps
Index.defaultProps = {
  appName: "componyInfoSearch"
}
...
// const appName = "myfirstapp";
// <Index appName={appName} appVersion="1.0.0" appAuthor="joyjoe" />
// ReactDOM.render(
//   (
//     <Index appVersion="1.0.0" appAuthor="joyjoe" />
//   ),
//   document.getElementById("app")
// );